...
//     <div className="max-w-2xl mx-auto p-6 bg-white rounded-2xl shadow-md mt-20">
...
//         />
//         <div>
//           <h1 className="text-3xl text-gray-400 font-bold">{user.name}</h1>
...
//         <p className="text-gray-400"><strong>Joined:</strong> {user.joined}</p>
//         <p className="text-gray-400"><strong>Bio:</strong> {user.bio}</p>
//       </div>
